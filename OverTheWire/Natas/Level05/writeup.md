...
With the help of the interceptor, we refreshed the page to see what is the `GET REQUEST`.
  <img width="1185" height="479" alt="image" src="https://github.com/user-attachments/assets/730d9e0b-d2e3-40a0-8e66-ba238b44adef" />

There is a cookie, named : `loggedin`.Whose parameter is set to be `1`.
<img width="1250" height="666" alt="natas29" src="https://github.com/user-attachments/assets/6fd4d243-0ebc-46b0-ac74-b47e05cb3aae" />

Now, it is the mechanism used by the developer to restrict us from the password of the next level.
But, we can bypass it by simply changing it to `0`, as shown below :
